...
mel_basis = librosa.filters.mel(
    22050, n_fft=1024, fmin=125, fmax=7600, n_mels=80)
...
if __name__ == "__main__":
    ...
    paser.add_argument(
        "-i", "--input_dir", default="data/features/dog/audio_10s_22050hz"
    )
    paser.add_argument(
        "-o", "--output_dir", default="data/features/dog/melspec_10s_22050hz"
    )
    ...
    with Pool(args.num_worker) as p:
        p.map(partial(get_spectrogram, save_dir=output_dir,
              length=length), audio_paths)
